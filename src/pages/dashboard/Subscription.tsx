  ...
  const plans: Plan[] = [
    {
      ...
      features: [
        { text: "AI Agent Bot Matchmaking (5 searches/day)", included: true },
        { text: "Basic campaign browsing", included: true },
        { text: "Limited analytics dashboard", included: true },
        { text: "Community support", included: true },
        { text: "Basic search filters", included: true },
        { text: "Advanced analytics", included: false },
        { text: "E-contracts via SignWell", included: false },
    ...
    },
    {
      ...
      features: [
        { text: "100 Premium AI Matchmaking credits", included: true },
        { text: "Up to 3 active campaign slots", included: true },
        { text: "Basic e-contracts via SignWell", included: true },
        { text: "In-app chat communication", included: true },
        { text: "Basic KOL performance tracking", included: true },
    ...
    },
    {
      ...
      features: [
        { text: "250 Premium AI Matchmaking credits", included: true },
        { text: "Up to 10 active campaign slots", included: true },
        { text: "Advanced e-contracts with templates", included: true },
        { text: "Smart routing for creator matching", included: true },
        { text: "Comprehensive campaign analytics", included: true },
    ...
    },
    {
      ...
      features: [
        { text: "600 Premium AI Matchmaking credits", included: true },
        { text: "Unlimited campaign slots", included: true },
        { text: "Custom e-contract builder via SignWell", included: true },
        { text: "Advanced KOL performance tracking", included: true },
        { text: "Campaign automation & optimization", included: true },
